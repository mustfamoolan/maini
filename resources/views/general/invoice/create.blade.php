                            ...
                            <div class="">
                                <div class="w-50 auth-logo border border-primary bg-light-subtle p-2 rounded" style="border-style: dashed !important;">
                                    <div class="profile-photo-edit">
                                        ...
                                        <label for="profile-img-file-input" class="profile-photo-edit avatar-xs"><img src="/images/logo.png" class="logo-dark me-1 user-profile-image" alt="user-profile-image" height="24"></label>
                                    </div>
                                </div>
                                <div class="mt-5 pt-2">
                                    <form>
